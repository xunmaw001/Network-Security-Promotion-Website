...
public class BumenguizhangEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public BumenguizhangEntity() {

	}

	public BumenguizhangEntity(T t) {
		try {
    ...
    public String toString() {
        return "Bumenguizhang{" +
            "id=" + id +
            ", bumenguizhangName=" + bumenguizhangName +
            ", bumenguizhangPhoto=" + bumenguizhangPhoto +
            ", insertTime=" + insertTime +
            ", bumenguizhangContent=" + bumenguizhangContent +
