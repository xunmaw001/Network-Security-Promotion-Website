...
public class ShifajieshiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public ShifajieshiCollectionEntity() {

	}

	public ShifajieshiCollectionEntity(T t) {
		try {
