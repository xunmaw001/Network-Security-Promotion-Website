...
public class XingzhengfaguiEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XingzhengfaguiEntity() {

	}

	public XingzhengfaguiEntity(T t) {
		try {
    ...
    public String toString() {
        return "Xingzhengfagui{" +
            "id=" + id +
            ", xingzhengfaguiName=" + xingzhengfaguiName +
            ", xingzhengfaguiPhoto=" + xingzhengfaguiPhoto +
            ", insertTime=" + insertTime +
            ", xingzhengfaguiContent=" + xingzhengfaguiContent +
