 ...
 * @date 2021-04-12
 */
@TableName("falvgagui_collection")
public class FalvgaguiCollectionView extends FalvgaguiCollectionEntity implements Serializable {
	...
	public FalvgaguiCollectionView() {

	}

	public FalvgaguiCollectionView(FalvgaguiCollectionEntity falvgaguiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, falvgaguiCollectionEntity);
