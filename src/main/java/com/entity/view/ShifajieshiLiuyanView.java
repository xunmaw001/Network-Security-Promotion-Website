...
public class ShifajieshiLiuyanView extends ShifajieshiLiuyanEntity implements Serializable {
	...
	public ShifajieshiLiuyanView() {

	}

	public ShifajieshiLiuyanView(ShifajieshiLiuyanEntity shifajieshiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, shifajieshiLiuyanEntity);
