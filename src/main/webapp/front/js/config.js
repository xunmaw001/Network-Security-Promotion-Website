...
var centerMenu = [
    ...
    ,{
        name: '法律法规收藏',
        url: '../falvgaguiCollection/list.jsp'
    }
    ,{
        name: '司法解释收藏',
        url: '../shifajieshiCollection/list.jsp'
    }
...
var indexNav = [
    {
        name: '法律法规',
        url: './pages/falvgagui/list.jsp'
    },
    {
        name: '司法解释',
        url: './pages/shifajieshi/list.jsp'
    },
    {
        name: '政策文件',
        url: './pages/zhengchengwenjian/list.jsp'
    },
    {
        name: '规范文件',
        url: './pages/guifanwenjian/list.jsp'
    },

    {
        name: '行政法规',
        url: './pages/xingzhengfagui/list.jsp'
    },
    {
        name: '部门规章',
        url: './pages/bumenguizhang/list.jsp'
    },


]

var adminurl =  "http://localhost:8080/wangluoxuancuan/index.jsp";
