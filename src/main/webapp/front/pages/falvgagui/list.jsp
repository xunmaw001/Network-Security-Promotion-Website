                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../falvgagui/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../falvgagui/detail.jsp?id='+item.id)"><span>{{item.falvgaguiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 falvgaguiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            falvgaguiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#falvgaguiName').val() != null && jquery('#falvgaguiName').val() != "" && jquery('#falvgaguiName').val() != "null" ) {
                param['falvgaguiName'] = jquery('#falvgaguiName').val();
                                    ...
                                    // 获取列表数据
            http.request('falvgagui/list', 'get', param, function(res) {
