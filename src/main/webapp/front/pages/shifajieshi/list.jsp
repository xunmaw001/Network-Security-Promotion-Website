                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../shifajieshi/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../shifajieshi/detail.jsp?id='+item.id)"><span>{{item.shifajieshiName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shifajieshiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shifajieshiContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (jquery('#shifajieshiName').val() != null && jquery('#shifajieshiName').val() != "" && jquery('#shifajieshiName').val() != "null" ) {
                param['shifajieshiName'] = jquery('#shifajieshiName').val();
                                    ...
                                    // 获取列表数据
            http.request('shifajieshi/list', 'get', param, function(res) {
