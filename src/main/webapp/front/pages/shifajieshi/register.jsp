                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="shifajieshiName" id="shifajieshiName"  placeholder="名称"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">赞:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="zanNumber" id="zanNumber"  lay-verify="integer|required"   placeholder="赞" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">踩:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="caiNumber" id="caiNumber"  lay-verify="integer|required"   placeholder="踩" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
