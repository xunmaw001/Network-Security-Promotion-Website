...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">司法解释留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">司法解释留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">司法解释留言列表</h3>
    ...
    <script>
        ...
        function getDataList() {
            http("shifajieshiLiuyan/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(yonghuNameCell);
                ...
                //留言内容
            var shifajieshiLiuyanContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.shifajieshiLiuyanContent && item.shifajieshiLiuyanContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.shifajieshiLiuyanContent.indexOf('<img');
                var endIndex = item.shifajieshiLiuyanContent.indexOf('>');
                    shifajieshiLiuyanContentCell.innerHTML = item.shifajieshiLiuyanContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.shifajieshiLiuyanContent != null && item.shifajieshiLiuyanContent != "" && item.shifajieshiLiuyanContent.length >= 11) {
                        shifajieshiLiuyanContentCell.innerHTML = item.shifajieshiLiuyanContent.substring(0, 10) + "...";
                } else {
                        shifajieshiLiuyanContentCell.innerHTML = item.shifajieshiLiuyanContent;
                }
            }
            row.appendChild(shifajieshiLiuyanContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("shifajieshiLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addshifajieshiLiuyan", "addshifajieshiLiuyan");
            window.location.href = "add-or-update.jsp"
        }
